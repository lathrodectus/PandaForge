...
namespace instance_check_internal
{
	...
	static bool  send_message(const std::string &message_text, const std::string &version)
	{
		...
		if ( !checker->IsAnotherRunning() ) */
		{
			...
			std::string		object_name = "/com/pandaforge/BambuStudio/InstanceCheck/Object" + version;
...
namespace MessageHandlerDBusInternal
{
	...
	static DBusHandlerResult handle_dbus_object_message(DBusConnection *connection, DBusMessage *message, void *user_data)
	{
	    ...
	    std::string our_interface  = "com.pandaforge.BambuStudio.InstanceCheck.Object" + wxGetApp().get_instance_hash_string();
...
void OtherInstanceMessageHandler::listen()
{
	...
	std::string			 interface_name = "com.pandaforge.BambuStudio.InstanceCheck.Object" + instance_hash;
    std::string			 object_name 	= "/com/pandaforge/BambuStudio/InstanceCheck/Object" + instance_hash;
